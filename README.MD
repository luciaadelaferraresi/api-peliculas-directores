...
Se incluye el archivo [Diagrama Entidad-Relacion](DER.png) que representa las entidades "Película" y "Director" con una relación de 1 a N:
...
| DELETE | `/api/peliculas/:id/resenias` | Eliminar reseña |
